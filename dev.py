...
class MHA(nn.Module):
    ...
    def __init__(self, config):
        ...
        # q, k, v for all projections in a single batch
    ...
    def forward(self, x):
        B, T, C = x.size() # C is embedding dimensionality (n_embd)
        # calculating q, k, v for all heads in a batch
        # GPT-2 (124M), n_head = 12, head_size = 64, n_head * head_size = n_embd (784)
        qkv = self.c_attn(x) # B,T, n_embd*3` for qkv
